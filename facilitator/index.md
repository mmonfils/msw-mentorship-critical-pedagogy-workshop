...
* **The Problem:** Discuss how administrative deficits create an unstable baseline for emerging practitioners in field placements.
* **Core Source Check:** Situate this within *Miehls et al. (2013)* to validate how satisfaction drops when supervisor interactions remain strictly administrative.
...
* **The Pivot:** Explain how an institution exhibits structural drift when it reacts to crises rather than designing equity directly into the system.
* **Core Source Check:** Reference *Freire (1970)* and *Hooks (1994)* to build the foundation for liberating education through horizontal relationships.
...
* **The Focus:** Emphasize the high importance placed on fast response times (under 24 hours) from institutional figures and the reliance on unofficial group chats.
* **Core Source Check:** Use *Mitschke et al. (2021)* to illustrate how student-led virtual peer mentorship models emerged out of necessity during system-wide crises.
